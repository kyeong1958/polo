...
//	JLabel	jl_mong_ver = new JLabel("mongTalk.ver1 and 최신버전입니다.",img_mong,JLabel.RIGHT);
	...
	public void initDisplay() {
		...
		gl.setVerticalGroup(
				...
				.addGroup(gl.createParallelGroup())
					.addComponent(jp_title,30,30,30)
				.addGroup(gl.createParallelGroup())
					.addComponent(jp_north,70,70,70)
				.addGroup(gl.createParallelGroup())
					.addComponent(jp_south)
				);
		...
		gl2.setHorizontalGroup(gl2.createSequentialGroup()
				.addGroup(gl2.createParallelGroup()
						.addComponent(jp_mong,120,120,120))
				.addGroup(gl2.createParallelGroup()
						.addComponent(jp_mong_ver))
				);
		gl2.setVerticalGroup(
				gl2.createSequentialGroup()
				.addGroup(gl2.createParallelGroup()
						.addComponent(jp_mong)
						.addComponent(jp_mong_ver)
						));
